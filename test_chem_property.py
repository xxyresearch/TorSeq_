...
parser.add_argument('--in_confs', type=str, default='./sampled_pickle/TorDiff+LSTMhead/LSTMHEAD.pkl', help='Pickle with input conformers')
parser.add_argument('--skip', type=int, default=1, help='Frequency for running procedure')
parser.add_argument('--out_confs', type=str, default='./xTB_pickle/xTB_reslstm.pkl', help='Path to output pickle')
...
parser.add_argument('--xtb_energy', action='store_false', default=True, help='Whether to comput xTB energies')
parser.add_argument('--xtb_path', type=str, default='/home/xxu9212/anaconda3/envs/TDIFF/bin/xtb', help='Specifies local path to xTB installation')
...
new_mols = {}
id = 0
for smi, _, _ in tqdm.tqdm(test_data):
    if smi not in mols:
